...
class PlaygroundDragElement(Layout):
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(children=self._trigger_layout, parent=self._trigger_layout,
                  size=self._trigger_layout, pos=self._trigger_layout)
